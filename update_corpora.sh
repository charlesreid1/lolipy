...
# project and copies all the data files to lolipy/data/corpora. The resulting
# data is then committed to the lolipy repository.
#
# Currently this is the most reliable way to make sure lolipy ships
# with _some_ version of corpora, even though it probably won't be the
# latest version by the time lolipy is installed.
#
# For history, see:
...
CORPORA_DEST_DIR='lolipy/data/corpora-original'
